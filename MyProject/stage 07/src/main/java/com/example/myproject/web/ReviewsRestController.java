...
//    @PutMapping()
//    public ResponseEntity<ReviewSummeryView> createNewReview(@RequestBody ReviewSummeryView reviewSummeryView,
//                                                             UriComponentsBuilder uriComponentsBuilder) {
////        long reviewId = this.reviewService.createNewReview(reviewSummeryView);
//        URI location = uriComponentsBuilder.path("/review/{id}").buildAndExpand(reviewId).toUri();
