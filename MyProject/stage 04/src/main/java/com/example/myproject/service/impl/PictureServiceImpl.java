...
public class PictureServiceImpl implements PictureService {
    ...
    public void initPictures() {
        ...
        if (this.pictureRepository.count() == 0) {
            ...
            String url = "https://res.cloudinary.com/malmsuite/image/upload/v1636643353/AndroriaCourseProjectSamplePictures/doublerooom_i1lnyq.jpg";
            String public_id = "i1lnyq";
            FacilityEnum facility = FacilityEnum.DOUBLE_ROOM;
            addFacilitiesPictures(url, facility, public_id);

            url = "https://res.cloudinary.com/malmsuite/image/upload/v1636643353/AndroriaCourseProjectSamplePictures/apartment_zzjajc.jpg";
            facility = FacilityEnum.APARTMENT;
            public_id = "zzjajc";
            addFacilitiesPictures(url, facility, public_id);

            url = "https://res.cloudinary.com/malmsuite/image/upload/v1636643352/AndroriaCourseProjectSamplePictures/studio_sdgeih.jpg";
            public_id = "sdgeih";
            facility = FacilityEnum.STUDIO;
            addFacilitiesPictures(url, facility, public_id);

            url = "https://res.cloudinary.com/malmsuite/image/upload/v1636643523/AndroriaCourseProjectSamplePictures/parking_pqz7te.jpg";
            public_id = "pqz7te";
            facility = FacilityEnum.PARKING;
            addFacilitiesPictures(url, facility, public_id);

            url = "https://res.cloudinary.com/malmsuite/image/upload/v1636643353/AndroriaCourseProjectSamplePictures/restaurant_ndnyil.jpg";
            public_id = "ndnyil";
